//Fri Jun 28 2024 10:32:38 GMT+0000 (Coordinated Universal Time)
  ...
  try {
    ...
    if (_0x508782?.["code"] == 0) {
      ...
      if (_0x508782[_0x14f289]) {
        ...
        _0x145844.status == 0 ? _0xf4231c >= _0x145844.version ? ([], _0x49dfef.log(_0x145844.msg[_0x145844.status]), _0x49dfef.log(_0x145844.updateMsg), _0x49dfef.log("现在运行的脚本版本是：" + _0xf4231c + "，最新脚本版本：" + _0x145844.latestVersion)) : _0x49dfef.log(_0x145844.versionMsg) : _0x49dfef.log(_0x145844.msg[_0x145844.status]);
      } else {
